/** One block per line of the archived Substack export. Edit this file to change copy. */
export const declarationParagraphs: string[] = [
  "Cantonese Script Reform 粵字改革",
  "Cantonese Script Reform 粵字改革",
  "粵字改革宣言 | The Cantonese Script Reform Proclamation | ",
  "粵語配有自己的文字｜Cantonese deserves its own script | ",
  "粵字改革 Cantonese Script Reform",
  "Oct 01, 2024",
  "English translation below.",
  "Thanks for reading 粵字改革’s Substack! Subscribe for free to receive new posts and support my work.",
  "Type your email...",
  "Subscribe",
  "【粵字改革宣言】",
  ...
  "Type your email...",
  "Subscribe",
  "Subscribe to Cantonese Script Reform 粵字改革",
  "By 粵字改革 Cantonese Script Reform · Launched 2 years ago",
  "Advocating for the reform of the Cantonese writing system, as well as its vocabulary, its orthography, its grammar, so that the language may become as dignified and intellectually powerful as English, French, Japanese, and Korean.",
  "Type your email...",
  "Subscribe",
  ...
  "Peter Cyrus",
  "24 Feb",
  "Hi there! I'm the designer of a competing proposal for a phonetic script for Cantonese. You can take a look at musa.bet/yue.",
  "Just to open a discussion, I see several advantages to Musa:",
  "1. The letters are much simpler and thus easier to write and to distinguish.",
  "2. Musa writes the tones.",
  "3. Because Musa can be used to write other languages, it will have more support from phones, fonts, keyboards, etc.",
  "4. A purely Cantonese script won't be read by foreigners (including other Chinese) and will therefore require glosses in Honzi or romanization or both on every sign.",
  "5. If I interpret it correctly, Jyutcitzi can't write all dialects of Cantonese - Musa can.",
  "But Musa isn't a Chinese-origin solution, nor a derivative of Honzi: it's internationalist as opposed to nationalist.Of course, most of the digital tools we use nowadays to write and communicate are also international; it doesn't seem to be a problem.",
  "Thanks for looking!",
  "Like",
  "Reply",
  "Share",
  "Written Cantonese must have word segmentation.",
  "Written Cantonese must have spaces, like Korean.",
  "Feb 22 • 粵字改革 Cantonese Script Reform",
  "4",
  "1",
  "點解要粵字改革？點解改革要用粵切字？",
  "粵字改革，就係改革粵語所用嘅文字，去完成廣東話嘅書 面語構建工程。粵切字，就係粵字改革嘅最好方案。",
  "Jan 25 • 粵字改革 Cantonese Script Reform",
  "4",
  "1",
  "The Possibility and Need for a Linear Jyutcitzi Cantonese Orthography",
  "Jyutcitzi is like Hangul in the sense that the canonical jyutcitzi orthography organizes letters into syllables and compose them into glyphs.",
  "Mar 23 • 粵字改革 Cantonese Script Reform",
  "3",
  "1",
  "Ready for more ?",
  "Type your email...",
  "Subscribe",
  "© 2026 粵字改革 Cantonese Script Reform · Privacy ∙ Terms ∙ Collection notice",
  "Start your Substack",
  "Get the app",
